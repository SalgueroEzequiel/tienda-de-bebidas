...
1. Abrir la consola en esta carpeta con ctrl+ñ
    ...
    b. npm init y hacer enter hasta que aparezca "is this OK? (yes), luego un ultimo enter.
...
4. En la consola correr el comando
    ...
    b. npm run watch-css // Cada vez que entremos al archivo para seguir editando.
